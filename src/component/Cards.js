  ...
  return (
    <Card sx={{ maxWidth: 345 ,borderRadius: 0 , pb:1 ,borderColor:"white"}}>
      <CardActionArea  onMouseEnter={() => setIsShown(true)}
        ...
        <Button onClick={props.onClick}  variant="outlined" style={{color:"gray" ,borderColor:"lightgray", borderRadius:0}} size="small" endIcon={<ShoppingCartIcon />}>Add to Cart</Button>
